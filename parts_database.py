...
PLAYER_LEFT_ARMS = {
    ...
    '62型 臂盾 + CC-20 单手剑（左）': Part(name='62型 臂盾 + 未完成的CC-20 单手剑（左）', armor=5, structure=0,
                                                 parry=3, actions=[ACTION_HUIZHAN]),
...
PLAYER_RIGHT_ARMS = {
    ...
    '63型 臂炮 + CC-20 单手剑（右）': Part(name='63型 臂炮 + 未完成CC-20 单手剑（右）', armor=4, structure=0, parry=2,
                                               actions=[ACTION_HUIZHAN, ACTION_SUSHE_BIPAO]),
}

PLAYER_BACKPACKS = {
    'AMS-190 主动防御': Part(name='AMS-190 主动防御', armor=3, structure=0, electronics=1),
    '未完成的TB-600 跳跃背包': Part(name='未完成的TB-600 跳跃背包', armor=3, structure=0, evasion=2,
...
AI_ONLY_LEGS = {
    'TK-05 坦克履带': Part(name='TK-05 坦克履带', armor=7, structure=2, evasion=0, adjust_move=1,
                           actions=[ACTION_BENPAO]),
}
