...
ACTION_HEAVY_STRIKE = Action(name='近距开火', action_type='近战', cost='S', dice='5黄', range_val=1)
...
PLAYER_LEFT_ARMS = {
    ...
    '无武装 (左)': Part(name='无武装机械臂 (左)', armor=3, structure=1, parry=0, actions=[]),
}
...
PLAYER_BACKPACKS = {
    ...
    #'JB-11 喷气背包': Part(name='JB-11 喷气背包', armor=2, structure=0, evasion=1),
}
...
AI_ONLY_LEFT_ARMS = {
    'LH-8 早期型霰弹破片炮': Part(name='LH-8 早期型霰弹破片炮', armor=5, structure=0, parry=0, actions=[ACTION_HEAVY_STRIKE]),
}
