...
from ._actions import (ACTION_BENPAO, ACTION_JINGJU, ACTION_PAOJI, ACTION_BATLLETYPE, ACTION_TUIJING, ACTION_DIANSHE_RF,
                       ...
                       ACTION_COORDINATED_OBSERVATION, ACTION_CHARGE, ACTION_SLIDE_JUMP
                       )
...
AI_ONLY_CORES = {
    ...
    'TM31Q “野猫”主战核心': Part(name='TM31Q “野猫”主战核心', armor=4, structure=4, electronics=1, evasion=3, actions=[ACTION_COORDINATED_OBSERVATION]),
}
...
AI_ONLY_LEFT_ARMS = {
    ...
    'S9 “流星”盾 + IGX106 离子炮': Part(name='S9 “流星”盾 + IGX106 离子炮', armor=4, structure=0, parry=2, evasion=1, actions=[ACTION_DUNJI, ACTION_DIANSHE_IGX106, ACTION_CHARGE])
}
...
AI_ONLY_BACKPACKS = {
    ...
    'JP5 机动提升包': Part(name='JP5 机动提升包', armor=3, structure=0, evasion=2, actions=[ACTION_SLIDE_JUMP]),
}